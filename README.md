...
The **Argus Neural Interface Bridge** is a **micro-ROS client** for the Argus Neural Interface MCU. It is intended to let the embedded device publish telemetry into the Argus ROS 2 graph. Eventually efforts will be put towards safety and receive inbound commands from the host side.
